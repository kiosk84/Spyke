  ...
  return (
    <div className="bg-dark-secondary p-8 rounded-2xl shadow-lg border border-dark-tertiary/50 max-w-4xl mx-auto text-light-primary">
      ...
      <div className="space-y-4 text-light-secondary">
        <p>
          Добро пожаловать в «Искру» — ваш персональный инструмент для разжигания творчества с помощью искусственного интеллекта. Наше приложение создано, чтобы помочь вам легко и быстро создавать высококачественные промпты для генерации изображений и воплощать ваши самые смелые идеи в жизнь.
        </p>
        <p>
          Мы используем мощь передовых моделей Google — Gemini для интеллектуального улучшения ваших текстовых идей и Imagen для их визуализации. Просто опишите свою концепцию, выберите стиль, освещение и другие параметры, и «Искра» превратит это в детализированный промпт, готовый к генерации шедевра.
        </p>
        ...
        <ol className="list-decimal list-inside space-y-2">
         ...
         <p className="pt-4">
          «Искра» создана для художников, дизайнеров, маркетологов и всех, кто хочет исследовать безграничные возможности генеративного искусства. Экспериментируйте, творите и делитесь своими результатами!
        </p>
      </div>
    </div>
  );
